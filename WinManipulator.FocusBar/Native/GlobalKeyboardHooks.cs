...
namespace WinManipulator.FocusBar
{
    ...
    class GlobalKeyboardHook : IDisposable
    {
        ...
        public GlobalKeyboardHook()
        {
            ...
            _windowsHookHandle = User32.SetWindowsHookEx(WH_KEYBOARD_LL, _hookProc, _user32LibraryHandle, 0);
        ...
        protected virtual void Dispose(bool disposing)
        {
            ...
            if (_user32LibraryHandle != IntPtr.Zero)
            {
                if (!Kernel32.FreeLibrary(_user32LibraryHandle)) // reduces reference to library by 1.
                {
                    int errorCode = Marshal.GetLastWin32Error();
